...
router.post("/prospect/question", contactProspect);// envía la pregunta al correo de soporte y marque el prospecto como sin atender
...
router.put("/prospect/answer", contactProspect);//manda el correo con la respuesta y marca al prospecto como atendido
